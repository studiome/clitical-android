...
MIT License が対象とするのは本リポジトリのソースコードです。予測モデルそのものおよびその出典論文
（[参考文献](#参考文献)を参照）には及ばず、また上記の免責事項を無効にするものでもありません。配布された
アプリの利用については、別途[利用規約](https://studiome.github.io/clti_risk/)に従います。
